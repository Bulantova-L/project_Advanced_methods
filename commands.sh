...
bedtools intersect -a data/maternal.bed -b data/methylation_maternal.bed -wa -wb > data/genes_maternal_overlap.bed
bedtools intersect -a data/paternal.bed -b data/methylation_paternal.bed -wa -wb > data/genes_paternal_overlap.bed

# Summarize results (e.g., count number of methylated sites per gene):
